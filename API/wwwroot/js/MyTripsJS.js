...
function displayTrips(item) {
    ...
    var myvar = '<br><div class="h5 container shadow-sm p-3 mb-5 bg-white rounded bg-light rounded-lg p-3 tripListItem" > ' +
        ...
        '        <div class="row">' +
        '            <div class="d-inline col-sm-2 ml-auto"> <h4>Your status: </h4>' + status +
        '            </div>' +
        '            </div>' +
